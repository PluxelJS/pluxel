 ...
 *
 * Intended uses:
 * - `ExtensionCompilerService`: dev-bundle plugin UI entries into a single ESM module for the browser.
...
export class BundlerService {
	...
	private resolveWorkerPath(): string {
		...
		const candidates = [
			...
			pathToFileURL(resolve(pkgRoot, 'src/dev/compile/bundler/bundle-worker.mjs')).href, // source fallback
		]
