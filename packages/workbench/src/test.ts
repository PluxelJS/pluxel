import type { ServiceTestHost, ServiceTestHostOptions } from '@pluxel/services/test'
...
import { createWorkbenchTestDriver } from './testing/driver'
import type { WorkbenchTestDriver } from './testing/contracts'
...
export type { WorkbenchTestDriver, WorkbenchTestOpenOptions } from './testing/contracts'
export type { WorkbenchOpenableEntry, OpenedLocalWorkbenchEntry } from './local-entry'
