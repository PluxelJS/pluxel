export interface ManagementSocket {
	readonly readyState: number
	/** Return false when the carrier cannot accept the message within its send budget. */
...
/** Adapts one already-open carrier socket to Cap'n Web's small DOM WebSocket surface. */
export class RuntimeSessionWebSocket {
	...
	constructor(
		private readonly socket: ManagementSocket,
