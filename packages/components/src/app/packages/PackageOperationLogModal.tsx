...
import type { OperationLogEntry } from './packageManagerModel'

interface PackageOperationLogModalProps {
	opened: boolean
	onClose: () => void
	title: string
...
export function PackageOperationLogModal({
	opened,
	onClose,
	title,
	logs,
	logModule = 'package-manager',
}: PackageOperationLogModalProps) {
	return (
		<Modal
			opened={opened}
			onClose={onClose}
