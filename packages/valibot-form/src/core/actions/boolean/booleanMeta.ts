...
export interface booleanMetaAction<TInput extends boolean, TMetadata extends BooleanMetaOptions>
...
export function booleanMeta<TInput extends boolean, const TMetadata extends BooleanMetaOptions>(
	metadata_: TMetadata,
): booleanMetaAction<TInput, TMetadata> {
	return {
		kind: 'metadata',
		type: 'boolean',
