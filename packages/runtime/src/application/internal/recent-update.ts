...
import { PluginRecentUpdateTracker, type PluginUpdateBatchSnapshot } from '../../internal.ts'

/** Static route owns sequence and scope; common Runtime owns snapshot attribution and retention. */
export class RuntimeRecentUpdateTracker extends PluginRecentUpdateTracker {
	recordDefinitions(
