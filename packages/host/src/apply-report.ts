...
import type { PluginReconciliationIssue } from './reconcile'
...
export type PluginApplyReportSnapshot = Readonly<{
...
/** Projects Core identities once for every Host control-plane consumer. */
export function projectPluginApplyReport(
	ctx: Context,
	report: PluginApplyReport<CommitSummary>,
...
function projectReconciliationIssue(issue: PluginReconciliationIssue): PluginReconciliationIssue {
	switch (issue.kind) {
