 ...
 *
 * Framework protocol suites can stage catalog, raw config and lifecycle before one commit. Plugin-author tests must use `createServiceTestHost()` from `@pluxel/preset/test`.
 */
