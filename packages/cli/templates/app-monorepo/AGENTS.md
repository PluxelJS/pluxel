...
- required plugin dependencies belong in constructors; host-managed optional integrations use `plugins.use(Token)`;
  package-optional implementations use module-level `optionalPlugin()` refs;
