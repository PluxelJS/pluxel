	...
	it('consumes package-root lowering across built toolchain/runtime packages', async () => {
		...
		await fixture.writeFile(
			...
			[
				...
				"import { ConfiguredPlugin, ConfiguredPluginConfig, runtimePlugins, ViteStatic } from '@fixture/vite-static'",
				...
				'        enabled: defaultNode && east && west ? [defaultNode, east, west, configuredNode] : [configuredNode],',
