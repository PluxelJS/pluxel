...
export type { StaticRuntimeInternalHmrReport, StaticRuntimeInternalStartupReport } from './types.ts'

/** @internal Privileged raw Context host for this package's framework conformance tests. */
export function startStaticApplicationInternalTestHost<
...
/** @internal Opens Runtime Session through the production Node WebSocket carrier. */
