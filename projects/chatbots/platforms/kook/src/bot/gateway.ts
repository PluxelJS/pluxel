...
import type { KookEvent } from './events.types.ts'

const SIGNAL_EVENT = 0
const SIGNAL_HELLO = 1
const SIGNAL_PING = 2
const SIGNAL_PONG = 3
const SIGNAL_RESUME = 4
const SIGNAL_RECONNECT = 5
const SIGNAL_RESUME_ACK = 6
...
/** Owns one KOOK gateway connection, including heartbeat, resume and retry state. */
