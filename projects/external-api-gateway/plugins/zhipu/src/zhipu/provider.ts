...
export type ZhipuFileParserToolType = 'lite' | 'expert' | 'prime' | 'prime-sync' | string

export type ZhipuFileParserFormatType = 'text' | 'download_link' | string

export type ZhipuFileParserUploadInput = {
	fileName: string
	contentType?: string
	bytes: Uint8Array | ArrayBuffer
	file_type: string
	tool_type: ZhipuFileParserToolType
	[key: string]: unknown
}

export type ZhipuFileParserResultInput = {
	task_id?: string
	taskId?: string
	format_type?: ZhipuFileParserFormatType
}
