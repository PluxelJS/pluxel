...
| `docs`        | Fumapress/Waku site built from the repository's `user-docs/` Markdown source. |
...
[`pluxel source`](../user-docs/development/source-workspaces.md), rather than becoming nested members of this
workspace.
