...
and dynamic development are modes of the same application server, while `host/web` remains plain
browser source without a package manifest or Pluxel imports.
