...
export const KK = {
  BUTTON, MESSAGE,
  BUTTON_CLICK, MESSAGE_CREATED, MESSAGE_DELETED, MESSAGE_UPDATED, MESSAGE_PINNED, MESSAGE_UNPINNED,
  REACTION_ADDED, REACTION_REMOVED, CHANNEL_ADDED, CHANNEL_UPDATED, CHANNEL_DELETED,
  PRIVATE_MESSAGE_CREATED, PRIVATE_MESSAGE_DELETED, PRIVATE_MESSAGE_UPDATED,
  PRIVATE_REACTION_ADDED, PRIVATE_REACTION_REMOVED,
  MEMBER_JOINED, MEMBER_EXITED, MEMBER_UPDATED, MEMBER_ONLINE, MEMBER_OFFLINE,
  ROLES_ADDED, ROLES_REMOVED, ROLES_UPDATED,
  GUILD_UPDATED, GUILD_DELETED, BLOCK_ADDED, BLOCK_REMOVED,
  EMOJI_ADDED, EMOJI_REMOVED, EMOJI_UPDATED,
  VOICE_JOINED, VOICE_EXITED, USER_UPDATED, SELF_GUILD_JOINED, SELF_GUILD_LEAVE,
} as const
