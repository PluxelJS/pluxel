...
description: 用静态规则保护 Plugin metadata、config、ownership 和 lifecycle 约束。
---

# Pluxel Oxlint 规则

普通 Oxlint 负责 JavaScript/TypeScript 质量；`@pluxel/rolldown/oxlint` 负责只有 Pluxel semantic model 才能判断的作者约束。
