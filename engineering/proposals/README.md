...
- [`WORKBENCH_STANDARD_PAGES.md`](WORKBENCH_STANDARD_PAGES.md)：Markdown-only Standard Page 已落地；提案只保留
  snapshot、data invalidation/watch 与 action 是否值得扩展的真实用例 gate。
