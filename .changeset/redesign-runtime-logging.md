...
sinks, stores, installation, and shutdown. Keep `LoggerService` exclusively on the dedicated core
logger entry instead of duplicating it through the broad services barrel.
